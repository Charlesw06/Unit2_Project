...
public class EquationRunner {
    public static void main(String[] args) {
        ...
        int x1 = parseInt(userPoint1.substring(1, userPoint1.indexOf(",")));
        int y1 = parseInt(userPoint1.substring(userPoint1.indexOf(",") + 1, userPoint1.length() - 1));

        Scanner point2Input = new Scanner(System.in);
        System.out.print("Enter the first x-y coordinate point: ");
        String userPoint2 = point2Input.nextLine();

        int x2 = parseInt(userPoint2.substring(1, userPoint2.indexOf(",")));
        int y2 = parseInt(userPoint2.substring(userPoint2.indexOf(",") + 1, userPoint2.length() - 1));
